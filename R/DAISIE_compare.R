...
## This function without calculation absolute difference betwwen different models,to see compared with DAISIE, TRASIE is larger or smaller
compare_diff2 <- function(
  DAISIE_output,
  TRASIE_output1,
  TRASIE_output2,
  TRASIE_output3,
